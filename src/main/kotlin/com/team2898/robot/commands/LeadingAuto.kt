...
class LeadingAuto : CommandBase() {
    ...
    override fun initialize() {
        var firstPath: Trajectory = PathPlanner.loadPath("LeadingAutoP1", 8.0, 1.5, true) // TODO: Max Viable Speed
        var secondPath: Trajectory = PathPlanner.loadPath("LeadingAutoP2", 8.0, 1.5, true) // TODO: Max Viable Speed
