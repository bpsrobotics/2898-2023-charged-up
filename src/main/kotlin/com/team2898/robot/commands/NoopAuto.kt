...
class NoopAuto : CommandBase() {
    ...
    override fun initialize() {
        var firstPath: Trajectory = PathPlanner.loadPath("New New Path", 5.0, 1.5) // TODO: Max Viable Speed
...
//        }
        ...
        moveCommandGroup = ParallelDeadlineGroup(
            FollowPath(firstPath, true),
            RunIntake(RunIntake.Ball.BLUE_2)
        )
