...
object Arm : SubsystemBase() {
    ...
    fun pos(): Double {
        ...
        return (-(if (p < 0.505) {
            ...
            p
        }) * 165.688247975 + 215.199342194).degreesToRadians() - (-0.568584 - 0.16458363) - (0.65 - 0.17453293) + 0.05 - 0.061268369999999 - 0.30541637 - -0.19769663 - (0.290913 - LOWER_SOFT_STOP) - (0.258227 - LOWER_SOFT_STOP)
    }
