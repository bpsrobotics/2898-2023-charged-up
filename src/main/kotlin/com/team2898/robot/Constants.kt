...
object Constants {
    ...
    const val DRIVETRAIN_KS = 0.11 / 12  // Voltage to make the motor start turning
    ...
    const val DRIVETRAIN_KP = 4.0 / 12 // Proportional PID component
    ...
    const val CLIMBER_ENDSTOP_L = 100000
    const val CLIMBER_ENDSTOP_R = 100000
